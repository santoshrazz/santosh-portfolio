...
const Footer = () => {
  return (
    <div>
      <footer className="bg-gray-100 dark:bg-gray-900 py-12 mt-12 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
            <p>
              &copy; {new Date().getFullYear()} Santoshmanav.site . All rights
              reserved.
            </p>
          </div>
        </div>
