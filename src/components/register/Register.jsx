...
export default function RegisterForm() {
  ...
  // Handle submit to handle register form submission
  const handleSubmit = async (e) => {
    ...
    try {
      // Simulate API call
      const registerUserResponse = await axios.post("/api/user/register", {
        name,
        email,
        phone,
        password,
      ...
      showAlert(
        err?.response?.data?.message || "Error While Registering",
        "error"
      );
